                    ...
                    <div className="article1">
                        ...
                        <div>
                            <div className="bloquee2">
                                <p>Existen 20 <Link to="/aminoacidos" className="ref" onClick={window.scrollTo(0, 0)}><b>aminoácidos</b></Link> que participan de la formación de <Link to="/proteinas" className="ref" onClick={window.scrollTo(0, 0)}><b>proteínas</b></Link> en el cuerpo y la L-Glutamina es uno de ellos. Es un <Link to="/aminoacidos" className="ref" onClick={window.scrollTo(0, 0)}><b>aminoácido</b></Link> de categoría no esencial, lo que significa que el organismo tiene la facultad de sintetizarlo gracias a la intervención de los grupos amino presentes en los alimentos.</p>
                                <p>A diario es posible que enfrentes situaciones de estrés mental y físico, además, no hay que engañarnos, los años hacen su trabajo y las cantidades de L-Glutamina naturales en tu cuerpo disminuyen.</p>
                                <p>El estrés puede ser oxidativo y, a pesar de que tu cuerpo produzca este <Link to="/aminoacidos" className="ref" onClick={window.scrollTo(0, 0)}><b>aminoácido</b></Link> de forma natural, a mayor cantidad de estrés que cualquiera sea sometido, más demanda tendrá tu organismo de este. Los deportistas culturistas, por su parte, para no sufrir la disminución de masa muscular ingieren <Link to="/glutamina" className="ref" onClick={window.scrollTo(0, 0)}><b>Glutamina</b></Link>, así pueden evitar las consecuencias del estrés oxidativo.</p>
                            </div>
